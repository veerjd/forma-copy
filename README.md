...
# Forma Copy: Copywriting

A Claude skill for writing marketing copy in a direct, practitioner voice. Built for product builders who know what they want to say and need help saying it without the fluff, the hedging, or the AI-generated filler that makes everything sound the same.
...
- Pricing pages
- About pages
- Newsletter and announcement copy

---

## What you get

- A voice guide grounded in direct, practitioner writing
- Page structure frameworks for every major page type
- CTA copy principles (and a list of what never to write)
- Blog and long-form guidance
- A pre-submission checklist that catches the most common copy failures
